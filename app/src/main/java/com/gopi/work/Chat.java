...
public class Chat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAttach = (ImageButton) findViewById(R.id.uAttach);
        mSend = (ImageButton) findViewById(R.id.uSend);
        mMessage = (EditText) findViewById(R.id.uMessage);
        ...
        mChatUserRef = FirebaseDatabase.getInstance().getReference().child("User");
       ...
       // displayName.setText(mChatUserRef.child(mChatUser).child("name").);
    ...
    private void sendMessage() {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            Map messageUserMap = new HashMap();
            messageUserMap.put(currentUserRef + "/" + userPushID, messageMap);
            messageUserMap.put(chatUser + "/" + userPushID, messageMap);
